 ...
 */
public class ComandoUpdateCliente implements Comando {
	@Override
	public Contexto execute(Object data) throws ExcepcionNegocio {
		...
		Boolean s = sa.updateCliente(t);
		Contexto responseContext = null;
		if(s){
			responseContext = new Contexto(EventoNegocio.UPDATE_CLIENTE_EXITO, s);
		}
		else{
			responseContext = new Contexto(EventoNegocio.UPDATE_CLIENTE_FRACASO, null);
		}
